...
SND_SOC_DAILINK_DEFS(sec_tdm_rx_0,
	...
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
#elif defined(CONFIG_TARGET_PRODUCT_SHENG)
SND_SOC_DAILINK_DEFS(sec_tdm_rx_0,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_CODEC("cs35l43.3-0040", "cs35l43-pcm"),
			   		   COMP_CODEC("cs35l43.3-0041", "cs35l43-pcm"),
					   COMP_CODEC("cs35l43.3-0042", "cs35l43-pcm"),
					   COMP_CODEC("cs35l43.2-0040", "cs35l43-pcm"),
